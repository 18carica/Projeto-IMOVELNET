...
<body>
    ...
    <div class="container my-5">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <div class"row">
                    <table>
                        <tr>
                            <td><a href="imovel_editar.php?imovel=<?php echo $imovel["codigo"] ?>"   class="btn btn-warning btn-sm">Editar</a></td>
                            <td><a href="imovel_excluir.php?imovel=<?php echo $imovel["codigo"] ?>"  class="btn btn-danger btn-sm">Excluir</a></td>
                        </tr>    
                    </table>
                </div>
            </div>
        ...
        <div class="mt-4">
            <a href="imoveis_listagem_cardex.php" class="btn btn-secondary">Voltar à Listagem</a>
        </div>
    </div>
